...
export const UpdateUserScreen = ({ navigation }: Props) => {
    ...
    return (
        <View>
            ...
            <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                <TouchableOpacity style={styles.btn} onPress={() => { update(user),navigation.navigate('ListarUsuarios'), cleanForm("apellido") }}>
